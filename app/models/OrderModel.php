...
");
    ...
    COUNT(*) AS total_orders,   -- all orders
    SUM(CASE WHEN status = 'Ready' THEN 1 ELSE 0 END) AS ready_orders,  -- count ready orders
    SUM(CASE WHEN status = 'Ready' THEN final_amount ELSE 0 END) AS revenue, -- revenue from ready
